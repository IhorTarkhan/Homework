...
private:
        ...
        if (number_1.get_negative())
            if (number_2.get_negative())
                if (number_1.is_it_more_or_equal_modular(number_2))
                    ...
                    return 7;
            else if (number_1.is_it_more_or_equal_modular(number_2))
                return 6;
            else
                return 3;
        else if (number_2.get_negative())
            if (number_1.is_it_more_or_equal_modular(number_2))
                return 4;
            else
                return 5;
    ...
    vector<int>
    subtraction_two_modules_numbers_in_vectors(vector<int> number_1_in_vector, vector<int> number_2_in_vector) {
        int max_length_of_two_numbers = max_of_two_numbers(number_1_in_vector.size(), number_2_in_vector.size());
    ...
    vector<int>
    multiplication_two_modules_numbers_in_vectors(vector<int> number_1_in_vector, vector<int> number_2_in_vector) {
        vector<int> composition_in_vector = {0};
        for (int i = 0; i < number_2_in_vector.size(); i++) {
            for (int j = 0; j < number_2_in_vector[i]; j++) {
                composition_in_vector = adding_two_modules_numbers_in_vectors(composition_in_vector,
                                                                              shift(number_1_in_vector,
                                                                                    number_2_in_vector.size() - i - 1));
            }
        }
    ...
    vector<int>
    division_two_modules_numbers_in_vectors(vector<int> number_1_in_vector, vector<int> number_2_in_vector) {
        ...
        while (is_first_more_than_second_or_equal_modular(number_1_in_vector, number_2_in_vector)) {
            while (is_first_more_than_second_or_equal_modular(number_1_in_vector,
                                                              shift(number_2_in_vector, shift_of_number_2))) {
                shift_of_number_2++;
            }
            shift_of_number_2--;
            vector<int> rez = {0};
            while (is_first_more_than_second_or_equal_modular(number_1_in_vector,
                                                              shift(number_2_in_vector, shift_of_number_2))) {
                rez[0]++;
                number_1_in_vector = subtraction_two_modules_numbers_in_vectors(number_1_in_vector,
                                                                                shift(number_2_in_vector,
                                                                                      shift_of_number_2));
            }
            difference_in_vector = adding_two_modules_numbers_in_vectors(difference_in_vector,
                                                                         shift(rez, shift_of_number_2));
            shift_of_number_2 = 0;
        }
        return difference_in_vector;
    }
...
public:
    ...
    LongNumber addition(LongNumber number_1, LongNumber number_2) {
        vector<int> sum_in_vector = adding_two_modules_numbers_in_vectors(number_1.get_number_in_vector(),
                                                                          number_2.get_number_in_vector());
        vector<int> difference_1_in_vector = subtraction_two_modules_numbers_in_vectors(number_1.get_number_in_vector(),
                                                                                        number_2.get_number_in_vector());
        vector<int> difference_2_in_vector = subtraction_two_modules_numbers_in_vectors(number_2.get_number_in_vector(),
                                                                                        number_1.get_number_in_vector());
    ...
    LongNumber multiplication(LongNumber number_1, LongNumber number_2) {
        vector<int> composition_in_vector = multiplication_two_modules_numbers_in_vectors(
                number_1.get_number_in_vector(), number_2.get_number_in_vector());
        switch (check_for_negative_and_position(number_1, number_2)) {
            case 1:
            case 2:
            case 7:
    ...
    LongNumber division(LongNumber number_1, LongNumber number_2) {
        vector<int> difference_in_vector = division_two_modules_numbers_in_vectors(number_1.get_number_in_vector(),
                                                                                   number_2.get_number_in_vector());
        switch (check_for_negative_and_position(number_1, number_2)) {
            case 2:
            case 8:
